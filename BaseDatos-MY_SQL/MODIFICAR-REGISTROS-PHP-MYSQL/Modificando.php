...
<?php
    ...
    $consulta = "UPDATE PRODUCTOS SET CÓDIGOARTÍCULO='$codigoArticulo',NOMBREARTÍCULO='$nombreArticulo',SECCIÓN='$seccionArticulo',PRECIO=$precioArticulo,IMPORTADO='$importadoArticulo',PAÍSDEORIGEN='$origenArticulo',FECHA='$fechaArticulo',FOTO='$fotoArticulo' WHERE CÓDIGOARTÍCULO = '$codigoArticulo';";
...
?>
    <button onclick="location.href='Pagina.php'">Regresar</button>
</body>
</html>