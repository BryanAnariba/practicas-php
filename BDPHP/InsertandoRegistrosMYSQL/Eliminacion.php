    ...
    <section class="form_wrap">
        ...
        <form action="Eliminacion.php" method="POST" class="form_contact">
            ...
            <?php
                ...
                <input type="button" value="Insertar Datos" id="btnVolver" onclick=" location.href='index.php'">
                <input type="button" value="Actualizar Datos" id="btnVolver" onclick=" location.href='actualizarRegistros.php'">
            </div>
        </form>
    </section>
